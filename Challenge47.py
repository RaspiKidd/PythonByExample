...
# Challenge 047 - Ask the user to enter a number and then enter another number.
# Add these two numbers together and then ask if they want to add another number.
# If they enter "y", ask them to enter another number and keep adding numbers until
